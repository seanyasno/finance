...
echo "📝 Creating consolidated Models.swift..."

# Create consolidated Models.swift from generated types
...
echo "🧹 Cleaning up openapi-generator artifacts..."
rm -rf "$OUTPUT_DIR/OpenAPIClient"
...
echo ""
echo "Models synchronized with API. Manual models in Models/ folder"
echo "continue to provide computed properties and iOS conveniences."

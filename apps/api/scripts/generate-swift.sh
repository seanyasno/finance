...
# Generates a consolidated Models.swift for iOS app from running API server
...
echo "📝 Creating Models.swift with clean type names..."

# Create consolidated Models.swift from API spec
cat > "$OUTPUT_DIR/Models.swift" << 'SWIFT_EOF'
//
// Models.swift
// finance
//
...
echo "✅ Models.swift generated successfully"
echo "📁 Output: apps/finance/finance/Generated/Models.swift"
echo ""
echo "✨ All types use clean names (Transaction, not GeneratedTransaction)"
echo "   Models synchronized with API schema"
